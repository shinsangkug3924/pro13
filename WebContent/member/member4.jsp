...
%> 
    ...
    <%--2. 요청한 값 얻기(가입을 위해 입력한 값들 request에서 얻기)
    	...
    	회원가입창(memberForm.html)에서 전달된 값들은  
    	<input>태그들의 name속성값과 
    	<jsp:setProperty>액션태그의 param속성의 값이 같으면?
    	request영역에서 모든 요청한 값들을 얻어  MemberBean객체의 각변수에 자동으로 저장시킵니다. 
    	단! 조건 -> MemberBean클래스의 각변수이름과 param속성의 값이름이 동일해야 한다는 조건이 있습니다.
     --%>	
	...
	<jsp:setProperty name="memberBean" property="email" param="emailsss"/>
